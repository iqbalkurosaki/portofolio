...
<head>
    ...
    <script src="js/form_sekret/kodepos1.js"></script>
...
<body>
    ...
    if (($_POST['submit'] == "Simpan")) {
        ...
        if ($verval == "BISMILLAH") {
            ...
            $sql = "INSERT INTO t_santri(nis,nik,nama,nama_panggilan,tempat_lahir,tgl_lahir,no_hp,profesi,jurusan,ayah,ibu,wali,tlp_rmh,alamat,kelurahan,kecamatan,kota,provinsi,kode_pos,tgl_masuk,id_komplek,id_kelas,id_status,lunas_administrasi,foto,kts)
							VALUES('" . $nis . "','" . $nik . "','" . $nama . "','" . $nama_panggilan . "','" . $tempat_lahir . "','" . $tgl_lahir . "','" . $no_hp . "','" . $institusi . "','" . $jurusan . "','" . $ayah . "','" . $ibu . "','" . $wali . "','" . $tlp_rmh . "','" . $alamat . "','" . $kelurahan . "','" . $kecamatan . "','" . $kota . "','" . $provinsi . "','" . $kode_pos . "','" . $tgl_masuk . "','" . $kamar . "','" . $kelas . "','" . $status_santri . "','" . $lunas_administrasi . "','0','0')";
    ...
    ?>
                ...
                // echo "<br><div class='alert alert-success' role='alert'>Selamat telah terdaftar dengan <strong>NIS " . $nis . ".</strong>";

                    alert("Selamat telah terdaftar dengan NIS "+<?php echo $nis ?>);
                    window.location.href = "index.php";
                </script>
    <?php
                // echp "Silahkan unggah foto dengan <a href='http://bit.ly/KTS_PPMH' target='_blank'>klik disini";
                echo "</div>";
                ?>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: white;">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"><strong>
                    <font color="#348A2B"><img src="img/logo.png" width="24"> SIAKAD PP. Miftahul Huda</font>
                </strong></a>
        </div>
    </nav>
        ...
        <table class="table table-striped">
            <thead>
                <tr style="background-color: green;">
                    <th colspan="2">
                        <h4 style="color: white;">Data Santri</h4>
                    </th>
                </tr>
            </thead>
            <tbody>
