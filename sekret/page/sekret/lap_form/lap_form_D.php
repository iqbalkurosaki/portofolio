<html>
	...
	<div class="table-responsive">
					...
					<tr><td><a href ="sekret/lap_cetak/lap_form_cetak_D.php" target="blank"> <span class='glyphicon glyphicon-print' style='font-size:20px; color:blue'> Cetak </span></a>	</td></tr>
					<tr class="success">
						<td width="4%" scope="col"><h4>D</h4></td>
						<td colspan="6"><h4>Laporan Data Santri Komplek Maulana Malik Ibrahim (D)</h4></td></tr>
					 	<?php
