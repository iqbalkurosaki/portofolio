<html>
	...
	<div class="table-responsive">
					...
					<tr><td><a href ="sekret/lap_cetak/lap_form_cetak_I.php" target="blank"> <span class='glyphicon glyphicon-print' style='font-size:20px; color:blue'> Cetak </span></a>	</td></tr>
					<tr class="success">
						<td width="4%" scope="col"><h4>A</h4></td>
						<td colspan="6"><h4>Laporan Data Santri Sunan Muria (I)</h4></td></tr>
	...
	<?php
	            ...
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '91'";
	            $no = 1;
	            ...
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '92'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
	          ...
	          //kamar: I3
	            ...
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '93'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
			...
			//kamar: I4
	            ...
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '94'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
