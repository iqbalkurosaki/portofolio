<html>
	...
	<div class="table-responsive">
					...
					<tr><td><a href ="sekret/lap_cetak/lap_form_cetaK_B.php" target="blank"> <span class='glyphicon glyphicon-print' style='font-size:20px; color:blue'> Cetak </span></a>	</td></tr>
					<tr class="success">
						<td width="4%" scope="col"><h4>B</h4></td>
						<td colspan="6"><h4>Laporan Data Santri Komplek Sunan Ampel (B)</h4></td></tr>
		 <?php
	          	include "sekret/lap_form.php";
	          	
	          	//kamar: b1
	          	echo '<tr class="success"><td width="3%" scope="col"><h4>1.</h4></td>
						<td colspan="2"><h4>Kamar : B1</h4></td><td colspan="4" align="right"><h4>Ketua Kamar : _________________</h4></td></tr>
						</table>
						<table  class="table table-bordered">
							<tr class="active"><th>No</th><th>Nis</th><th>Nama</th><th>No HP</th><th>Tempat, Tanggal Lahir</th><th>Alamat</th><th>Status</th></tr>';
			
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '21'";
	            $no = 1;
	        	...
	        	echo '</table><table  class="table table-stripped">';
	          	echo '<tr class="success"><td width="3%" scope="col"><h4>2.</h4></td>
						<td colspan="2"><h4>Kamar : B2</h4></td><td colspan="4" align="right"><h4>Ketua Kamar : _________________</h4></td></tr>
						</table>
						<table  class="table table-bordered">
							<tr class="active"><th>No</th><th>Nis</th><th>Nama</th><th>No HP</th><th>Tempat, Tanggal Lahir</th><th>Alamat</th><th>Status</th></tr>';
			
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '22'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
	          ...
	          //kamar: b3
	        	echo '</table><table  class="table table-stripped">';
	          	echo '<tr class="success"><td width="3%" scope="col"><h4>3.</h4></td>
						<td colspan="2"><h4>Kamar : B3</h4></td><td colspan="4" align="right"><h4>Ketua Kamar : _________________</h4></td></tr>
						</table>
						<table  class="table table-bordered">
							<tr class="active"><th>No</th><th>Nis</th><th>Nama</th><th>No HP</th><th>Tempat, Tanggal Lahir</th><th>Alamat</th><th>Status</th></tr>';
			
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '23'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
			...
			//kamar: b4
	        	echo '</table><table  class="table table-stripped">';
	          	echo '<tr class="success"><td width="3%" scope="col"><h4>4.</h4></td>
						<td colspan="2"><h4>Kamar : B4</h4></td><td colspan="4" align="right"><h4>Ketua Kamar : _________________</h4></td></tr>
						</table>
						<table  class="table table-bordered">
							<tr class="active"><th>No</th><th>Nis</th><th>Nama</th><th>No HP</th><th>Tempat, Tanggal Lahir</th><th>Alamat</th><th>Status</th></tr>';
			
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '24'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
	         ...
	         //kamar: b5
	        	echo '</table><table  class="table table-stripped">';
	          	echo '<tr class="success"><td width="3%" scope="col"><h4>5.</h4></td>
						<td colspan="2"><h4>Kamar : B5</h4></td><td colspan="4" align="right"><h4>Ketua Kamar : _________________</h4></td></tr>
						</table>
						<table  class="table table-bordered">
							<tr class="active"><th>No</th><th>Nis</th><th>Nama</th><th>No HP</th><th>Tempat, Tanggal Lahir</th><th>Alamat</th><th>Status</th></tr>';
			
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '25'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
	        	...
	        	echo '</table><table  class="table table-stripped">';
	          	echo '<tr class="success"><td width="3%" scope="col"><h4>6.</h4></td>
						<td colspan="2"><h4>Kamar : B6</h4></td><td colspan="4" align="right"><h4>Ketua Kamar : _________________</h4></td></tr>
						</table>
						<table  class="table table-bordered">
							<tr class="active"><th>No</th><th>Nis</th><th>Nama</th><th>No HP</th><th>Tempat, Tanggal Lahir</th><th>Alamat</th><th>Status</th></tr>';
			
	            $sql = "SELECT * FROM t_santri where id_komplek LIKE '26'";
	            $no = 1;
	            $result=$db->execute($sql);
	            while (!$result->EOF) {
					$nis= $result->fields["nis"];
