		...
		<div class="later">
			...
			<div class="container-fluid">
		  		<table class="table">	
					...
					$id =$_GET['id'];
	              	$sql="select * from t_santri, komplek,kelas,profesi,status_santri,provinsi,kota where t_santri.id_komplek=komplek.id_komplek and t_santri.id_kelas=kelas.id_kelas and t_santri.profesi=profesi.id_profesi and t_santri.id_status=status_santri.id_status and t_santri.kota=kota.id and t_santri.provinsi=provinsi.id and t_santri.nis = '$id' ";
		            ...
		            while (!$result->EOF) {
		                ...
		                $nama_institusi=$result->fields["nama_institusi"];
						...
						<tr><td>4. Alamat Rumah </td><td class="right-td">loremalsdjk aslkdjaslkjda slkjdlask djaslkdjlaskjdl askjdlaskdjlaskj daskldjaslkd jaslkdjaskldjas lkdaslkdj laskdjaslk : '.$alamat.','.$nama_kota.'. '.$nama_provinsi.'. Kode Pos :'.$kode_pos.'.</td></tr>
						<tr><td>5. No HP </td><td class="right-td">: '.$no_hp.'</td></tr>
						<tr><td>6. Profesi </td><td class="right-td">: '.$jurusan.'.'.$nama_institusi.'</td></tr>
		...
		<div class="later">		
			...
			<div class="table-responsive">
	  			<table class="table">
					...
					<tr>
						<td> Alamat Rumah </td>
						<td class="right-td">: <?php  $alamat.','.$nama_kota.'. '.$nama_provinsi.'. Kode Pos :'.$kode_pos; ?></td>
					</tr>
				</table>
			</div>
