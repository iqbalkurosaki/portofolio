...
session_start();
	...
	//include ('../assets/secure/secure_madros.php');
	/*
			...
			<a href="menu_madros.php">
			 ...
			 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="menu_madros.php?m=pengumuman">
                                <div>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="menu_madros.php?m=pertanyaan">
                                <div>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-dashboard fa-fw"></i>Presensi Santri<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                               <a href="menu_madros.php?a=input_pres">Input Presensi</a>
                            </li>
                            <li>
                                <a href="menu_madros.php?a=lap_pres">Laporan Presensi</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        <a href="#"><i class="fa fa-dashboard fa-fw"></i>Nilai Santri<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                               <a href="menu_madros.php?a=input_nilai">Input Nilai</a>
                            </li>
                            <li>
                                <a href="menu_madros.php?a=lap_nilai">Raport</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-dashboard fa-fw"></i>Update kelas<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                               <a href="menu_madros.php?a=update_kelas">Update Kelas Santri</a>
                            </li>
 ...
 if(!empty($_GET['a'])){
						$pages_dir='madros';
                		$madros = scandir($pages_dir,0);
						unset($madros[0], $madros[1]);
						
						$a = $_GET['a'];
						if(in_array($a.'.php', $madros)){
                			include($pages_dir.'/'.$a.'.php');
            			} else {
                			echo "<div class='alert alert-danger' role='alert'>Halaman tidak ditemukan! :(</div>";
            			}
