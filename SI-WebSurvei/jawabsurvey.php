...
<?php 
				$stmt = $db->prepare('SELECT * FROM survey_res2ponden WHERE token = ?');
...
?>
								<div class="jawaban wrap justify-content-start ">
									<textarea placeholder="Blablabla" rows="1" cols="30" name="jawaban" style="res2ize: both; width: 100%; !important; "></textarea>
								</div>
<?php
							}
?>
