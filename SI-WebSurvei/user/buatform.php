...
<head>
	...
	<script type="text/javascript">
		...
		var arrDesk = {judul : '', deskripsi : '',responden:respondenTmp}
...
<div class="container pb-5 ">
	<form id="formSurvey" enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
		<section id="AttrSurvei">
			<div class="card-deck">
				<div class="card bg-card-buatform my-5 shadow">
					<div class="text-center card-header text-light bg-dark-nav p-3">
...
?>
						...
						<div class="form-group pengisian row justify-content-end mb-5">
							...
							<input class="col-sm-3 form-control form-control-plaintext underline" type="date" name="batasWaktu" required="">
						</div>
		...
		<button type="button" class="btn btn-secondary p-3 my-5 btn-block btnNext bg-dark-nav">+ Tambah Soal</button>	
